...
public enum CoopEnemyInfoKey: String, UnsafeRawRepresentable {
    public static var defaultValue: Self = .SakelienBomber
    public var id: Int { CoopEnemyInfoId.allCases[CoopEnemyInfoKey.allCases.firstIndex(of: self) ?? 0].rawValue }
